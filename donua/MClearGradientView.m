//
//  MClearGradientView.m
//  Miya
//
//  Created by Luke Zhao on 2013-01-29.
//  Copyright (c) 2013 Luke Zhao. All rights reserved.
//

#import "MClearGradientView.h"

@implementation MClearGradientView
...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    /*NSGradient *gradient = [[NSGradient alloc] initWithColorsAndLocations:
     ...
     nil];*/
    NSGradient *gradient = [[NSGradient alloc] initWithColorsAndLocations:
                            [NSColor colorWithCalibratedRed:0.4f green:0.4f blue:0.4f alpha:0.6f], 0.0f,
                            [NSColor colorWithCalibratedRed:0.2f green:0.2f blue:0.2f alpha:0.6f], 1.0f,
                            nil];
